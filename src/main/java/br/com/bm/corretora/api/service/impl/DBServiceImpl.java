...
public class DBServiceImpl {
	...
	public void instanciaDB() {
		...
		usuario.setNome("Lucas Brum");
		usuario.setEmail("lucas@brumemacedocorretora.com.br");
		usuario.setDataNascimento(LocalDate.of(1989, 7, 29));
		usuario.setCpf("13605641792");
		usuario.setSenha(encoder.encode("1020304050"));
		usuario.setTelefone("21986604321");
		usuario.addPerfil(PerfilEnum.ADMIN);
